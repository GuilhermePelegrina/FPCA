function [M, A, B, A_orig, B_orig] = LFWProcess_mono_eq()
...
aux = min([size_female(1),size_male(1)]);

images_female = images_female(1:aux,:);
images_male = images_male(1:aux,:);
...
A_orig = images_centered(1:aux,:);
B_orig = images_centered(aux+1:end,:);

images_female = A_orig;
images_male = B_orig;
